...
```bash
python3 ~/.codex/skills/md2slides/scripts/generate_slides.py path/to/deep_dive_presentation.md path/to/output.pptx --images-dir path/to/images
```
...
/tmp/md2slides-venv/bin/python ~/.codex/skills/md2slides/scripts/generate_slides.py path/to/deck.md path/to/deck.pptx
```
