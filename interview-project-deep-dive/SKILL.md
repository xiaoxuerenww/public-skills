...
**Formatting:** When documenting tradeoffs, alternatives, and comparisons, use `$doc-formatter` conventions:
...
4. **Apply `$doc-formatter` conventions** when suggesting improvements:
